...
def post_detail(request, slug):
    ...
    prefetched_authors = Prefetch('author',
                                  queryset=User.objects.order_by('username'))
    comments = post.comments.all().prefetch_related(prefetched_authors)
    serialized_comments = []
